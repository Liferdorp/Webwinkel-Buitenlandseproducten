...
// Hier worden de producten geselecteerd waarvan het soort product Non-food is
...
AND `ARTIKEL`.`SoortProd` = 'Non-food';";
...
if($result === false) {
  echo "<p>Er zijn geen producten in de winkel gevonden die goedkoper zijn dan €5.00.</p>\n";
} else {
  $num = 0;
