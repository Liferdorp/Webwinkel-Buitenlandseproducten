...
if (empty($_SESSION['cart'])){
    ...
    $_SESSION['cart'] = $ArtikelNr.",".$hoeveelheid; // Het productnummer,hoeveelheid staat dus in een sessie
}
else {
    ...
    if ($add) { // Als we dus wel moeten toevoegen
        $_SESSION['cart'] = $_SESSION['cart']."|".$ArtikelNr.",".$hoeveelheid;
    }
}
